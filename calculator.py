...
class calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(width=17,bg='brown',font=('Aeial bold',28),textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11,height=4,text='=',relief='flat',bg='brown',command=self.solve).place(x=270,y=350)
        Button(width=11,height=4,text='C',relief='flat',bg='lightcoral',command=self.clear).place(x=0,y=350)
